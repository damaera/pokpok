    ...
    | {
        ...
        stats?:
          | Array<
              | {
                  __typename?: "Stat";
                  base_stat?: number | null | undefined;
...
export type ListPokemonsQuery = {
  ...
  pokemons?:
    | {
        ...
        prevOffset?: number | null | undefined;
        results?:
          | Array<
              | {
                  __typename?: "PokemonItem";
 ...
 * });
 */
export function useListPokemonsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    ListPokemonsQuery,
    ListPokemonsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<ListPokemonsQuery, ListPokemonsQueryVariables>(
    ListPokemonsDocument,
    options
  );
}
export function useListPokemonsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    ListPokemonsQuery,
    ListPokemonsQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<ListPokemonsQuery, ListPokemonsQueryVariables>(
    ListPokemonsDocument,
    options
  );
}
export type ListPokemonsQueryHookResult = ReturnType<
  typeof useListPokemonsQuery
>;
export type ListPokemonsLazyQueryHookResult = ReturnType<
  typeof useListPokemonsLazyQuery
>;
export type ListPokemonsQueryResult = Apollo.QueryResult<
  ListPokemonsQuery,
  ListPokemonsQueryVariables
>;
